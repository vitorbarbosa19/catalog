const prepareDataToPay = (state, sellerZoopId, charge, seller, sellerZoopPlan) => {
  ...
  return { sellerZoopId, charge, cardholder, month, year, number, cvv, installments, seller, sellerZoopPlan };
};
