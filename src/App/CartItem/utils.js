export const reduceItem = price => {
  ...
  rqReducer = (prev, [key, value]) => (key !== '' && value !== '' ? { ...prev, [key]: value } : prev),
  parseTotal = (productIds, products, prices) => (productIds && products ? productIds.reduce(reduceTotal(prices, products), [0, 0]) : [0, 0]);
