...
export const updateProductStock = (productSnapshot, cartItemSnapshot, newRequestedQuantities) => async (transaction) => {
        ...
        const [totalAvailable, newAvailable, newRequested] = calculateNewQuantities(newRequestedQuantities, requestedQuantities, availableQuantities);
